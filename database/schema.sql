...
('Wireless Mouse', 'Ergonomic wireless mouse with silent click technology, 3 adjustable DPI levels, and 12-month battery life. Compatible with Windows, Mac, and Chrome OS.', 24.99, 'https://images.unsplash.com/photo-1527864550417-7fd91fc488a5?w=400', 'Accessories', 50),
('USB Condenser Microphone', 'Professional USB condenser microphone with cardioid polar pattern, mute button, and volume control. Perfect for streaming, podcasting, and video calls.', 69.99, 'https://images.unsplash.com/photo-1590602847861-f357e9332bbc?w=400', 'Audio', 18),
('Adjustable Laptop Stand', 'Aluminum laptop stand with 6 adjustable height levels, heat dissipation, and foldable design. Compatible with laptops from 10 to 17.3 inches.', 29.99, 'https://images.unsplash.com/photo-1527864550417-7fd91fc488a5?w=400', 'Accessories', 35),
('External Hard Drive 2TB', 'Portable external hard drive with 2TB storage capacity, USB 3.0 high-speed transfer, and shock-resistant design. Compatible with PC, Mac, and gaming consoles.', 79.99, 'https://images.unsplash.com/photo-1531492746074-4b0d0e5e5c5a?w=400', 'Storage', 22);
